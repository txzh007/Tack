<template>
  <div class="add_pan">
    ...
    <el-tabs type="card">
      <el-tab-pane>
        <span slot="label">
          <i class="el-icon-date" /> 本次申请
        </span>
        <el-form ref="editForm" :model="editForm" inline label-width="200px" align="left">
          <el-form-item :label="$t('applythispay')" prop="amount">
            <el-input v-model="editForm.amount" :disabled="true" />
          </el-form-item>
          <el-form-item :label="$t('invoiceno')" prop="invoiceno">
            <el-input v-model="editForm.invoiceno" :disabled="true" />
          </el-form-item>
          ...
          <el-form-item :label="$t('taxrate')" prop="taxrate">
            <el-input v-model="editForm.taxrate" :disabled="true" />
          </el-form-item>
