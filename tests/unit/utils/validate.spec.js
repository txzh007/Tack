...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/txzh007/tack')).toBe(true)
    expect(validURL('http://github.com/txzh007/tack')).toBe(true)
    expect(validURL('github.com/txzh007/tack')).toBe(false)
  })
  it('validLowerCase', () => {
